...
class Tester:
    ...
    def __init__(self,
                 ...
                 tests_to_perform: List[str] = ('interval_estimator_min_max', 'interval_estimator_std', 'interval_estimator_mad', 'interval_estimator_pdf', 'interval_estimator_pdf_adaptive')):
